<!-- Banner -->
<?php include_once 'modules_m/slide/index.php'; ?>
...
<style type="text/css">
	...
	<div class="right-sidebar max270">
		<?php include_once 'modules_m/danhmuc-sidebar/index.php'; ?>
		<div class="clear20"></div>
		<div class="clear20"></div>
        <?php include_once 'modules_m/camnhan-sidebar/index.php'; ?>
        <div class="clear20"></div>
        <?php include_once 'modules_m/tuvan-sidebar/index.php'; ?>
	</div>
</div>
<div class="clear20"></div>
<?php include_once 'modules_m/moi-truong-dm/index.php'; ?>
<div class="clear20"></div>
