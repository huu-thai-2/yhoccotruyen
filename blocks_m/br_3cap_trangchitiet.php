...
<div class="breadcrumbs">
    ...
    <div class="breadcrumbs">
        <a href="/" class="pathway">Trang chủ</a>
        <?php if($idOng>0){ ?>
			 <img src="images/mobile/arrow.png" alt=""> 
			 <a href="<?php echo $TenLoaiOngKD; ?>/" class="pathway"><?php echo $TenLoaiOng; ?></a> 
		<?php } ?>
       	<?php if($idCha > 0){ ?>
			<img src="images/mobile/arrow.png" alt=""> 
			<a href="<?php echo $TenLoaiChaKD; ?>/" class="pathway"><?php echo $TenLoaiCha; ?></a>
		<?php } ?>
		<?php if($idCon > 0){ ?>
			<img src="images/mobile/arrow.png" alt=""> 
			<a href="<?php echo $TenLoaiConKD; ?>/" class="pathway"><?php echo $TenLoaiCon; ?></a>
		<?php } ?>
        <img src="images/mobile/arrow.png" alt=""> 
